...
def should_reask_user(intent, filtered_df, prompt, domain_keys, location_value):
    ...
    # If the user already specified a structured filter (domain/location),

    # let that route handle the response instead of re-asking too early.
